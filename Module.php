...
CREATE TABLE collecting_item (id INT AUTO_INCREMENT NOT NULL, item_id INT DEFAULT NULL, form_id INT NOT NULL, collecting_user_id INT NOT NULL, UNIQUE INDEX UNIQ_D414538C126F525E (item_id), INDEX IDX_D414538C5FF69B7D (form_id), INDEX IDX_D414538CB0237C21 (collecting_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
