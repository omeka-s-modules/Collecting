...
CREATE TABLE collecting_item (id INT AUTO_INCREMENT NOT NULL, item_id INT DEFAULT NULL, form_id INT NOT NULL, user_id INT NOT NULL, UNIQUE INDEX UNIQ_D414538C126F525E (item_id), INDEX IDX_D414538C5FF69B7D (form_id), INDEX IDX_D414538CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
CREATE TABLE collecting_user_input (id INT AUTO_INCREMENT NOT NULL, user_prompt_id INT NOT NULL, item_id INT NOT NULL, text LONGTEXT NOT NULL, INDEX IDX_D94F025FB52427DC (user_prompt_id), INDEX IDX_D94F025F126F525E (item_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
...
CREATE TABLE collecting_user_prompt (id INT AUTO_INCREMENT NOT NULL, form_id INT NOT NULL, position INT NOT NULL, text LONGTEXT DEFAULT NULL, input_type VARCHAR(255) DEFAULT NULL, select_options LONGTEXT DEFAULT NULL, required TINYINT(1) NOT NULL, INDEX IDX_818D001A5FF69B7D (form_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
...
ALTER TABLE collecting_item ADD CONSTRAINT FK_D414538CA76ED395 FOREIGN KEY (user_id) REFERENCES collecting_user (id) ON DELETE CASCADE;
ALTER TABLE collecting_user_input ADD CONSTRAINT FK_D94F025FB52427DC FOREIGN KEY (user_prompt_id) REFERENCES collecting_user_prompt (id) ON DELETE CASCADE;
ALTER TABLE collecting_user_input ADD CONSTRAINT FK_D94F025F126F525E FOREIGN KEY (item_id) REFERENCES collecting_item (id) ON DELETE CASCADE;
...
ALTER TABLE collecting_user_prompt ADD CONSTRAINT FK_818D001A5FF69B7D FOREIGN KEY (form_id) REFERENCES collecting_form (id) ON DELETE CASCADE;
