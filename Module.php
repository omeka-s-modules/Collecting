...
CREATE TABLE collecting_user_input (id INT AUTO_INCREMENT NOT NULL, user_prompt_id INT NOT NULL, collecting_item_id INT NOT NULL, text LONGTEXT NOT NULL, INDEX IDX_D94F025FB52427DC (user_prompt_id), INDEX IDX_D94F025F522FDEA (collecting_item_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
...
ALTER TABLE collecting_user_input ADD CONSTRAINT FK_D94F025F522FDEA FOREIGN KEY (collecting_item_id) REFERENCES collecting_item (id) ON DELETE CASCADE;
